...
\caption[Optional caption for list of figures]{The figures show various projections of the non-normalized one-body density of the symmetric solution for $\text{H}_2$.}
\label{fig:11}
\end{figure}
...
\caption[Optional caption for list of figures]{The figures show various projections of the non-normalized one-body density of the anti-symmetric solution for $\text{H}_2$.}
\label{fig:9}
\end{figure}
